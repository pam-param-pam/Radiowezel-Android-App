...
public class PlayerActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        TextView video_title = findViewById(R.id.AP_player_title);
        TextView video_desc = findViewById(R.id.AP_player_description);
        TextView video_id = findViewById(R.id.AP_player_id);
    ...
    public void onInitializationFailure(YouTubePlayer.Provider provider,
        ...
        Toast.makeText(this, result.toString() + "\nPerhaps you are lacking youtube app? Or it's disabled?", Toast.LENGTH_LONG).show();
    }
